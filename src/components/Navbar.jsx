    ...
    <div>
      <motion.div
        ...
        <div className='text-xl lg:text-2xl font-bold flex items-center gap-1'>
          <span className='text-white'>AppDev</span>
          <span className='text-purple-500'>Ace</span>
        </div>
        <div>
        ...
        <a className='lg:text-lg md:text-base bg-purple-500 hover:bg-purple-400 text-white px-4 py-2 rounded-full'>Download CV</a>
      </motion.div>
